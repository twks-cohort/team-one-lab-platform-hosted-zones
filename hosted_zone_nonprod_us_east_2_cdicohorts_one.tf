# # *.nonprod_us_east_2.cdicohorts.one

# # define a provider in the account where this subdomain will be managed
provider "aws" {
  alias  = "subdomain_nonprod_us_east_2_cdicohorts_one"
  region = "us-east-2"
  assume_role {
...
module "subdomain_nonprod_us_east_2_cdicohorts_one" {
  source  = "terraform-aws-modules/route53/aws//modules/zones"
  version = "2.0.0"
  create  = true

  providers = {
    aws = aws.subdomain_nonprod_us_east_2_cdicohorts_one
  }

  zones = {
    "nonprod-us-east-2.${local.domain_cdicohorts_one}" = {
      tags = {
        cluster = "nonprod"
      }
    }
...
module "subdomain_zone_delegation_nonprod_us_east_2_cdicohorts_one" {
  ...
  records = [
    {
      ...
      records         = lookup(module.subdomain_nonprod_us_east_2_cdicohorts_one.route53_zone_name_servers,"nonprod-us-east-2.${local.domain_cdicohorts_one}")
    }
  ]

  depends_on = [module.subdomain_nonprod_us_east_2_cdicohorts_one]
}
